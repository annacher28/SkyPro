...
def test_form_submission():
    ...
    try:
        ...
        danger_element = driver.find_element(By.CSS_SELECTOR, ".alert-danger")
        success_element = driver.find_element(By.CSS_SELECTOR, ".alert-success")
        assert danger_element.is_displayed() and success_element.is_displayed(), "Не все элементы отображаются корректно"
